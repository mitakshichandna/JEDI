...
public class Queries{
    ...
    public static final String ADD_COURSE = "insert into Course(courseId, coureName) values (?, ?)";
	public static final String REGISTER_STUDENT = "update Student set isRegistered = 1 where studentId = ?";
	public static final String ASSIGN_COURSE = "update Course set professorId = ? where courseCode = ?";
